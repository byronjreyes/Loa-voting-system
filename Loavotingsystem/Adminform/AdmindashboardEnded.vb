...
Public Class AdmindashboardEnded
    ...
    Private Sub AdmindashboardEnded_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadFinalizedResults()
        Try
            Using connection As New OleDbConnection(connectionString)
                ...
                ' Select the finalized results from tblResult
                Dim query As String = "SELECT * FROM tblResult"
                Using command As New OleDbCommand(query, connection)
                    Using reader As OleDbDataReader = command.ExecuteReader()
                        While reader.Read()
                            ' Create a new instance of a UserControl (you need to create a UserControl with labels)
                            Dim resultControl As New ResultUserControl()

                            ' Set the labels on the UserControl based on the data from tblResult
                            resultControl.LabelPresident.Text = reader("Firstname").ToString() & " " & reader("Lastname").ToString()
                            resultControl.LabelVicePresident.Text = reader("Title").ToString() ' Assuming you want to display Title here
    ...
    ' Method to load and display data for the candidate chart
